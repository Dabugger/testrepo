<script lang="ts">
	...
	import { flyAndScale } from '$lib/docs/utils/index.js';
	import { X } from 'lucide-svelte';
	import { CodeBlock } from '$lib/docs/components/index.js';
	import customEventDetail from '$lib/docs/data/long-types/custom-event-detail.html?raw';
