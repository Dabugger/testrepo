<script lang="ts">
	import type { APISchema } from '$lib/docs/types.js';
	import { transformAPIString } from '$lib/docs/utils/index.js';
	import { APITableHeading, InfoPopover } from '$lib/docs/components/index.js';
