import { ATTRS, DESCRIPTIONS, KBD, PROPS, SEE } from '$lib/docs/constants.js';
import type { KeyboardSchema } from '$lib/docs/types.js';
import { builderSchema, elementSchema } from '$lib/docs/utils/index.js';
