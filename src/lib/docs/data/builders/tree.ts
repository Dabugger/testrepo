import { DESCRIPTIONS, KBD, PROPS } from '$lib/docs/constants';
import type { KeyboardSchema } from '$lib/docs/types';
import { builderSchema, elementSchema } from '$lib/docs/utils';
